...
<body>
                    ...
                    <form action="/registro/store" method="POST">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="nombre" placeholder="Escriba su nombre" required id="nombre">
    ...
    <script>
        ...
        <?php if (session()->getFlashdata('success')): ?>
            Swal.fire({
                icon: 'success',
                title: '<?= session()->getFlashdata('Registro exitoso') ?>',
...
<script>
    function validarSoloLetras(inputElement, errorElement) {
    ...
    validarSoloLetras(nombreInput, errorNombre);
    validarSoloLetras(apellidoInput, errorApellido);
</script>
...
correoInput.addEventListener('input', function() {
    // Bloquea todo excepto letras, números, @ y punto
    this.value = this.value.replace(/[^a-zA-Z0-9@.-_]/g, '');

    // Expresión regular para validar formato básico: algo@dominio.com/mx
