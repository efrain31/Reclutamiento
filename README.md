...
```
cd existing_repo
git remote add origin https://repositorios.geovoy.com/desarrolloweb/escarh2.0.git
git branch -M main
...
- [ ] [Set up project integrations](https://repositorios.geovoy.com/desarrolloweb/escarh2.0/-/settings/integrations)
